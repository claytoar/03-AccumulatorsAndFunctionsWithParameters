...
def draw_circles2():
    ...
    window_two = rg.RoseWindow(400, 400)
    x = 0
    for k in range(18):
        x = (k * 20) + 50
        center = rg.Point(x, 100)
        circle_two = rg.Circle(center, 10)
        circle_two.fill_color = 'blue'
        circle_two.attach_to(window_two)
        window_two.render()

    window_two.close_on_mouse_click()
...
def draw_circles3():
    ...
    window_three = rg.RoseWindow(300, 300)
    radius = 0
    for k in range(100):
        center = rg.Point(200, 150)
        radius = k + 1
        circle_three = rg.Circle(center, radius)
        circle_three.attach_to(window_three)
        window_three.render()

    window_three.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    window_four = rg.RoseWindow(400, 400)
    x = 0
    y = 0
    for k in range(101):
        x = 200 + 80 * math.cos(k)
        y = 200 + 80 * math.sin(k)
        center = rg.Point(x, y)
        circle_four = rg.Circle(center, 10)
        circle_four.attach_to(window_four)
        window_four.render()

    window_four.close_on_mouse_click()
